...
const EducationItem: React.FC<EducationItemProps> = ({ institution, degree, period, showConnector }) => (
    <>
        ...
        <div className="flex flex-1 flex-col py-3">
            <p className="text-[var(--color-text)] text-base font-medium leading-normal">{degree}</p>
            <p className="text-[var(--color-text-muted)] text-sm font-normal leading-normal">{institution}</p>
            <p className="text-[var(--color-text-muted)] text-base font-normal leading-normal">{period}</p>
        </div>
    </>
)
